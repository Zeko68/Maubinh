...
window.createButton = function(box){
    box.innerHTML = '' +
        ...
        '    <button class="btn btn-sm btn-info" id="btnSapBai2" onclick="sapBaiSoi2()">Sắp Bài Soi</button>' +
        '    <button class="btn btn-sm btn-info" id="btnSapBai2" onclick="sapBaiSoi2Test()">Sắp Bài Soi Test</button>' +
        '</div>' +
...
window.showHideBoxSoi = function (button) {
...
window.sapBaiSoi2Test = function () {
    if (boxCardBinhSource == undefined || boxCardBinhSource == null || boxCardBinhSource.length == 0) {
        return;
    }
...
if (!f12sct) {
            ...
            if (cardsJson.data[0] !== "") {
                ...
                for (let posIndex = 0; posIndex < boxCardBinh.length; posIndex++) {
                    ...
                    for (let i = 0; i < boxCardBinh[posIndex].length; i++) {
                        ...
                        //drawCardsMB(idPlayerBox, playerCardOfThreeChi, id
                    }
    ...
    window.getCardSoi = async function (myCards, numOfPersons, arrPlayersInfo, myPosIndex, nextGame = 0) {
        ...
        if (type_game == "binh") {
            ...
            if (cardsJson.data[0] !== "") {
                window.boxCardBinhSource = [];
                console.log("dupRoomID: ", dupRoomID, " | ", "dupRecordID: ", cardsJson.data[0]['id']);
...
if (!boxSoi) {
    ...
    _div.innerHTML = '<input type="button" onclick="showHideBoxSoi(this)" value="Hide BoxSoi"/>';
