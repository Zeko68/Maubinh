...
window.createButton = function(box){
    box.innerHTML = '<style>.boxPlayMB5{color:#fff;border-radius:5px;border:none;padding:1px;margin:1px}#boxControl{position:fixed;z-index:999999;bottom:1%;left:40%}.boxPlayMB5.xepBaiDoiThu{top:0;left:0;position:fixed;}.btn-info{background:#003a7f;color:#fff;padding:5px;border-radius:10px}</style>' +
        ...
        '    <button class="btn btn-sm btn-info" id="btnSapBai" onclick="sapBai2()">Sắp Bài</button>' +
        '</div>' +
        '<div class="boxPlayMB5">' +
        '   <button class="btn btn-sm btn-info" id="btnCreateDupRoom" onclick="createDupRoom()">Tạo Phòng</button>' +
        '   <button class="btn btn-sm btn-info" id="btnCreateDupRoom" onclick="stopCreateDupRoom()">Dừng Tạo</button>' +
        '   <button class="btn btn-sm btn-info" id="btnCreateDupRoom" onclick="findDupRoom()">Tìm Phòng</button>' +
        ...
        '   <button class="btn btn-sm btn-info" id="btnCreateDupRoom" onclick="cloneComeIn()">Clone Vào</button>' +
        '   <button class="btn btn-sm btn-info" id="btnCreateDupRoom" onclick="cloneComeOut()">Clone Ra</button>' +
        '</div>' +
